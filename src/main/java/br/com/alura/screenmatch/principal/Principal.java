...
public class Principal {
        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    listarSeriesBuscadas();  // Este método já está fora de outro método, ok!
                    break;
                case 4:
    ...
    private void buscarEpisodioPorSerie() {
        listarSeriesBuscadas();  // Aqui é chamado corretamente fora de outro método
    ...
    private void buscarSeriesPorAtor() {
        ...
        System.out.println("Avaliações a patir de qual valor? ");
    ...
    private void buscarEpisodiosDepoisDeUmaData(){
        ...
        if(serieBusca.isPresent()){
            ...
            var anoLancamento = leitura.nextDouble();
            leitura.nextLine();
